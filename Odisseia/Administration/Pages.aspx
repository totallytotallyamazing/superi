<%@ Page Language="C#" MasterPageFile="~/Administration/MasterPage.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeFile="Pages.aspx.cs" Inherits="Administration_Pages" Title="Untitled Page" %>
...
//			}
	...
	<table style="width:100%; height:100%; padding-left:0px; border-collapse:collapse" cellpadding="0" cellspacing="0" >
		<tr>
			...
			<td style ="border:1px solid grey; text-align:left;" valign="top">
				...
				<table id="tDetails" style="text-align:left;">
					<tr>
						<td>
							Название(англ.):
						</td>
					...
					<tr>
						...
						<td style="width:100%;">
							...
							<div style="float:left; margin-left:10px; border:1px solid grey">
							    Изображение:<br />
