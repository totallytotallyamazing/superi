    ...
    public static class Configurator
    {
        ...
        public static SiteSettings LoadSettings()
        {
            ...
            return new SiteSettings{
                                          Languages = _dictionary["Language"],
                                          PageSize = Convert.ToInt32(_dictionary["PageSize"]),
                                          ReceiverMail = _dictionary["ReceiverMail"],
                                          ReceiverMail2 = _dictionary["ReceiverMail2"]
                                      };
        }
