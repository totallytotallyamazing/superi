<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Products/Products.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<Shop.Models.Product>>" %>
...
<asp:Content runat="server" ContentPlaceHolderID="SortingPanel">
    <%
        if (!Request.Url.ToString().ToLower().Contains("konkurs"))
