...
public partial class Administration_SEO : Page
{
	private int TextID
	{
		get
    ...
    private void SaveNavigation(Navigation Item)
    {
        ...
        Item.AdditionalTitleTextId = reAdditionalTitle.Values.Save();
	...
	{
		twPages.Nodes.Clear();
		NavigationList navigationList = new NavigationList(true, false);
    ...
    private void LoadContent()
    {
        ...
        if (navigation.ID > 0)
        {
            ...
            if (!string.IsNullOrEmpty(navigation.Picture))
                ibPicture.ImageUrl = DefaultValues.MenuImagesFolder + navigation.Picture;
            else
                  ibPicture.ImageUrl = "";
        }
    }
    ...
    {
        string path = Server.MapPath(DefaultValues.MenuImagesFolder) + "\\";
    ...
    private void RemovePicture(string PicturePath)
    {
        ...
        {
            string path = Server.MapPath(DefaultValues.MenuImagesFolder) + PicturePath;
            File.Delete(path);
        }
    }
