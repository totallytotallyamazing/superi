...
namespace Pandemiia.Models
{
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_ID", DbType="Int NOT NULL", IsPrimaryKey=true, IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		public int ID
		{
			get
			{
		...
		[Column(Storage="_Picture", DbType="VarChar(255)", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Preview", DbType="VarChar(255)", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Description", DbType="VarChar(250)", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
